...
if __name__=='__main__':
    while True:
        ...
        while startUp:
            ...
            elif "good bye" in statement or "ok bye" in statement or "stop" in statement or "nothing" in statement or "leave me alone" in statement or "never mind" in statement or "shut down" in statement:
